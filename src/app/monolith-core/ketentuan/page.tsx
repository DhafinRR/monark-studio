...
export default async function KetentuanPage() {
  const items = await getKetentuanItems()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Ketentuan & Syarat</h1>
          <p className="text-gray-500 text-sm">Kelola ketentuan pemesanan yang ditampilkan di halaman About.</p>
        </div>
        <Link
          href="/monolith-core/ketentuan/new"
      ...
      <KetentuanList initialItems={items as any} />
    </div>
  )
}
