...
export default function PrivacyPolicyEditor({ initialData }: PrivacyPolicyEditorProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Failed to update privacy policy')
    } finally {
